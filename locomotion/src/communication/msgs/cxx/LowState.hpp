...
*****************************************************************/
#ifndef DDSCXX_LOWSTATE_HPP_5D3B473E6F92F1568952DF2AC6D1A63B
#define DDSCXX_LOWSTATE_HPP_5D3B473E6F92F1568952DF2AC6D1A63B
...
public:
  ...
  void ddq(std::array<float, 12>&& _val_) { this->ddq_ = std::move(_val_); }
  ...
  void tau_est(std::array<float, 12>&& _val_) { this->tau_est_ = std::move(_val_); }
  ...
  void tmp(std::array<float, 12>&& _val_) { this->tmp_ = std::move(_val_); }
  ...
  void contact(std::array<float, 4>&& _val_) { this->contact_ = std::move(_val_); }
  ...
  void quat(std::array<float, 4>&& _val_) { this->quat_ = std::move(_val_); }
...
namespace {
  static const volatile propvec &properties___msgs__LowState = get_type_props<::msgs::LowState>();
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool write(T& streamer, const ::msgs::LowState& instance, const entity_properties_t *props) {
  (void)instance;
...
bool write(S& str, const ::msgs::LowState& instance, key_mode key) {
  const auto &props = get_type_props<::msgs::LowState>();
  str.set_mode(cdr_stream::stream_mode::write, key);
  return write(str, instance, props.data()); 
}

template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool read(T& streamer, ::msgs::LowState& instance, const entity_properties_t *props) {
  (void)instance;
  member_id_set member_ids;
  if (!streamer.start_struct(*props))
    return false;
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool read(S& str, ::msgs::LowState& instance, key_mode key) {
  const auto &props = get_type_props<::msgs::LowState>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool move(T& streamer, const ::msgs::LowState& instance, const entity_properties_t *props) {
  (void)instance;
  member_id_set member_ids;
  if (!streamer.start_struct(*props))
    return false;
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool move(S& str, const ::msgs::LowState& instance, key_mode key) {
  const auto &props = get_type_props<::msgs::LowState>();
...
template<typename T, std::enable_if_t<std::is_base_of<cdr_stream, T>::value, bool> = true >
bool max(T& streamer, const ::msgs::LowState& instance, const entity_properties_t *props) {
  (void)instance;
  member_id_set member_ids;
  if (!streamer.start_struct(*props))
    return false;
...
template<typename S, std::enable_if_t<std::is_base_of<cdr_stream, S>::value, bool> = true >
bool max(S& str, const ::msgs::LowState& instance, key_mode key) {
  const auto &props = get_type_props<::msgs::LowState>();
...
#endif // DDSCXX_LOWSTATE_HPP_5D3B473E6F92F1568952DF2AC6D1A63B
