  ...
  foreach(_tuple ${_exported_typesupport_libraries})
    ...
    if(NOT IS_ABSOLUTE "${_library}")
      ...
      if(NOT _lib)
        ...
        message(FATAL_ERROR "Package 'unitree_api' exports the typesupport library '${_library}' which couldn't be found")
      elseif(NOT IS_ABSOLUTE "${_lib}")
        # the found library must be an absolute path
        message(FATAL_ERROR "Package 'unitree_api' found the typesupport library '${_library}' at '${_lib}' which is not an absolute path")
