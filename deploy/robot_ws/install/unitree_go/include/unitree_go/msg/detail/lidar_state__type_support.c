...
void LidarState__rosidl_typesupport_introspection_c__LidarState_init_function(
...
void LidarState__rosidl_typesupport_introspection_c__LidarState_fini_function(void * message_memory)
{
  unitree_go__msg__LidarState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LidarState__rosidl_typesupport_introspection_c__LidarState_message_member_array[17] = {
  {
    "stamp",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LidarState__rosidl_typesupport_introspection_c__LidarState_message_members = {
  "unitree_go__msg",  // message namespace
  "LidarState",  // message name
  17,  // number of fields
  sizeof(unitree_go__msg__LidarState),
  LidarState__rosidl_typesupport_introspection_c__LidarState_message_member_array,  // message members
  LidarState__rosidl_typesupport_introspection_c__LidarState_init_function,  // function to initialize message memory (memory has to be allocated)
  LidarState__rosidl_typesupport_introspection_c__LidarState_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LidarState__rosidl_typesupport_introspection_c__LidarState_message_type_support_handle = {
  0,
  &LidarState__rosidl_typesupport_introspection_c__LidarState_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_go, msg, LidarState)() {
  if (!LidarState__rosidl_typesupport_introspection_c__LidarState_message_type_support_handle.typesupport_identifier) {
    LidarState__rosidl_typesupport_introspection_c__LidarState_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LidarState__rosidl_typesupport_introspection_c__LidarState_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
