...
void UwbState__rosidl_typesupport_introspection_c__UwbState_init_function(
...
void UwbState__rosidl_typesupport_introspection_c__UwbState_fini_function(void * message_memory)
{
  unitree_go__msg__UwbState__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember UwbState__rosidl_typesupport_introspection_c__UwbState_message_member_array[17] = {
  {
    "version",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers UwbState__rosidl_typesupport_introspection_c__UwbState_message_members = {
  "unitree_go__msg",  // message namespace
  "UwbState",  // message name
  17,  // number of fields
  sizeof(unitree_go__msg__UwbState),
  UwbState__rosidl_typesupport_introspection_c__UwbState_message_member_array,  // message members
  UwbState__rosidl_typesupport_introspection_c__UwbState_init_function,  // function to initialize message memory (memory has to be allocated)
  UwbState__rosidl_typesupport_introspection_c__UwbState_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t UwbState__rosidl_typesupport_introspection_c__UwbState_message_type_support_handle = {
  0,
  &UwbState__rosidl_typesupport_introspection_c__UwbState_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unitree_go, msg, UwbState)() {
  if (!UwbState__rosidl_typesupport_introspection_c__UwbState_message_type_support_handle.typesupport_identifier) {
    UwbState__rosidl_typesupport_introspection_c__UwbState_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &UwbState__rosidl_typesupport_introspection_c__UwbState_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
